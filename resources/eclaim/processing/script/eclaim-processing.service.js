(function() {
    ...
    function EclaimProcessingService() {
        this.getClaimsRequest = function() {
            return [
                {'claimNum' : 80010201,'reqNum': 987896, 'status':'Rejected', 'statusReason':'Waiting for Finalization', 'rejectedReason':'Waiting for Finalization', 'policyNum' : 'AE-1000', 'voucherNum' : 10, 'memberNum': 'MEM-001'},
                {'claimNum' : 80010201,'reqNum': 187896, 'status':'Approved', 'statusReason':'Waiting for Approval', 'rejectedReason':'Waiting for Finalization', 'policyNum' : 'AE-1001', 'voucherNum' : 16,'memberNum': 'MEM-0017'},
                {'claimNum' : 80010201,'reqNum': 287896, 'status':'Approved', 'statusReason':'Waiting for Finalization', 'rejectedReason':'Waiting for Finalization', 'policyNum' : 'AE-1002', 'voucherNum' : 15,'memberNum': 'MEM-0016'},
                {'claimNum' : 80010201,'reqNum': 387896, 'status':'Rejected', 'statusReason':'Waiting for Approval', 'rejectedReason':'Waiting for Finalization', 'policyNum' : 'AE-1003', 'voucherNum' : 14,'memberNum': 'MEM-0016'},
                {'claimNum' : 80010201,'reqNum': 487896, 'status':'Rejected', 'statusReason':'Waiting for Approval', 'rejectedReason':'Waiting for Finalization', 'policyNum' : 'AE-1004', 'voucherNum' : 13,'memberNum': 'MEM-0014'},
                {'claimNum' : 80010201,'reqNum': 587896, 'status':'Approved', 'statusReason':'Waiting for Approval', 'rejectedReason':'Waiting for Finalization', 'policyNum' : 'AE-1005', 'voucherNum' : 12,'memberNum': 'MEM-0013'},
                {'claimNum' : 80010201,'reqNum': 687896, 'status':'Approved', 'statusReason':'Waiting for Approval', 'rejectedReason':'Waiting for Finalization', 'policyNum' : 'AE-1006', 'voucherNum' : 11,'memberNum': 'MEM-002'}
            ];
        }
